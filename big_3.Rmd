...
ggplot(Big_3[Big_3$player %in% c("Federer", "Djokovic"),], aes(year, rolling_gs_avg_no_nadal)) +
  ...
  labs(
    ...
    y = "Grand Slams Won",
    color = "Player",
    title = "Federer and Djokovic 3-Year Average Annual Grand Slam Haul With No Nadal",
    subtitle = "Every year from 2003 - 2022") +
  theme_minimal()
```
```{r, echo = FALSE}
ggplot(Big_3[Big_3$player %in% c("Nadal", "Djokovic"),], aes(year, rolling_gs_avg_no_federer)) +
  ...
  labs(
    ...
    y = "Grand Slams Won",
    color = "Player",
    title = "Nadal and Djokovic 3-Year Average Annual Grand Slam Haul With No Federer",
    subtitle = "Every year from 2003 - 2022") +
  theme_minimal()
```
```{r, echo = FALSE}
